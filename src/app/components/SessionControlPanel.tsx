...
export default function SessionControlPanel({
  ...
  const [controlData, setControlData] = useState<SessionControlData | null>(
    null
  );
  ...
  return (
    <div className='bg-white rounded-lg border shadow-sm overflow-hidden'>
        ...
        <div className='flex items-center justify-between'>
          <div>
            ...
            <p className='text-sm text-gray-600'>
              {controlData.session.track.name} -{" "}
              {controlData.session.track.grade.name}
            </p>
          </div>
          <div
      ...
      <div className='p-4'>
            ...
            <div className='flex flex-wrap gap-2'>
              {controlData.availableActions.map((action) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 ${getActionButtonColor(
                    action.color
                  )}`}>
        ...
        {controlData.canControl &&
          controlData.availableActions.length === 0 && (
            <div className='text-center py-4 text-gray-500'>
