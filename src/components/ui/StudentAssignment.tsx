        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          <div className='p-4 bg-gray-50 rounded-lg'>
            ...
            <div className='space-y-1 text-sm text-gray-600'>
              <p>
                <span className='font-medium'>الاسم:</span> {student.name}
              </p>
              <p>
              ...
              {student.age && (
                <p>
                  <span className='font-medium'>العمر:</span> {student.age} سنة
                </p>
              )}
            </div>
          </div>
      ...
      <form onSubmit={handleSubmit} className='space-y-4'>
        ...
        <div>
          <div className='flex items-center justify-between mb-3'>
            <label className='block text-sm font-medium text-gray-700'>
              اختر الطلاب ({selectedStudentIds.length} من{" "}
        ...
        <div className='flex items-center justify-end space-x-3 space-x-reverse pt-4 border-t'>
          ...
          <button
            ...
            {loading
              ? "جاري التسجيل..."
              : `تسجيل ${selectedStudentIds.length} طالب`}
          </button>
        </div>
      </form>
    </Modal>
