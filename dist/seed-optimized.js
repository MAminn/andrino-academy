...
async function seed() {
    try {
        ...
        console.log(`- Attendance Records: ${await prisma.sessionAttendance.count()}`);
        console.log("\n🔐 Test Credentials:");
        ...
        console.log("Instructor: ahmed.instructor@andrino-academy.com / Instructor123!");
        console.log("Student: ali.student@andrino-academy.com / Student123!");
        console.log("Unassigned Student: hassan.student@andrino-academy.com / Student123!");
        console.log("\n📚 Academic Structure:");
        console.log(`- ${grades.length} Grades (المستويات)`);
        console.log(`- ${tracks.length} Tracks (المسارات)`);
        console.log(`- Live Sessions with External Coordination (Zoom, Google Meet)`);
        console.log("\n🚀 Ready for Testing:");
